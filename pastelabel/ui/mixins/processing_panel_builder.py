...
class ProcessingPanelBuilderMixin:
    ...
    def _build_pipeline_section(self, parent_layout):
        ...
        self._recipe_combo.setMinimumWidth(150)
        recipe_row.addWidget(self._recipe_combo)
        self._recipe_save_btn = QPushButton()
        self._recipe_save_btn.setObjectName("accentBtn")
        self._recipe_save_btn.clicked.connect(self._save_recipe)
        recipe_row.addWidget(self._recipe_save_btn)
        self._recipe_apply_btn = QPushButton()
        self._recipe_apply_btn.setObjectName("accentBtn")
        self._recipe_apply_btn.clicked.connect(self._apply_recipe)
        recipe_row.addWidget(self._recipe_apply_btn)
        self._recipe_del_btn = QPushButton()
        self._recipe_del_btn.setObjectName("accentBtn")
        self._recipe_del_btn.clicked.connect(self._delete_recipe)
        recipe_row.addWidget(self._recipe_del_btn)
