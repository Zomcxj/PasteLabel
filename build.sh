...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'pastelabel.engine.image_loader', 'pastelabel.engine.image_loader.status',
        'pastelabel.engine.image_loader.scan', 'pastelabel.engine.image_loader.mixin',
        'pastelabel.engine.paste_engine',
