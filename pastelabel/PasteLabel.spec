...
a = Analysis(
    ...
    hiddenimports=['pastelabel', 'pastelabel.ui', 'pastelabel.ui.main_window', 'pastelabel.ui.ui_builder', 'pastelabel.ui.settings_dialog', 'pastelabel.ui.theme', 'pastelabel.ui.dwm', 'pastelabel.ui.dialogs', 'pastelabel.ui.i18n', 'pastelabel.ui.processing_panel', 'pastelabel.ui.dataset_classifier_dialog', 'pastelabel.ui.mixins.dataset_classifier', 'pastelabel.engine', 'pastelabel.engine.save_manager', 'pastelabel.engine.undo_manager', 'pastelabel.engine.label_manager', 'pastelabel.engine.image_loader', 'pastelabel.engine.paste_engine', 'pastelabel.engine.event_handler', 'pastelabel.engine.augmenter', 'pastelabel.engine.augmenter.base', 'pastelabel.engine.augmenter.color', 'pastelabel.engine.augmenter.flipt', 'pastelabel.engine.augmenter.noise', 'pastelabel.engine.augmenter.translate', 'pastelabel.engine.augmenter.rotate', 'pastelabel.engine.augmenter.scale', 'pastelabel.engine.yolo_exporter', 'pastelabel.engine.splitter', 'pastelabel.engine.dataset_classifier', 'pastelabel.canvas', 'pastelabel.canvas.canvas', 'pastelabel.canvas.canvas_renderer', 'pastelabel.canvas.canvas_interaction', 'pastelabel.canvas.canvas_drawing', 'pastelabel.canvas.canvas_menu', 'pastelabel.core', 'pastelabel.core.config', 'pastelabel.core.config_manager', 'pastelabel.core.utils', 'pastelabel.core.editor_protocol', 'pastelabel.core.exception_hook', 'pkgutil'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
